...
const ProfessorDashboard = () => {
  ...
  const branchMetricsData = [
    { metric: "Total", value: mockAllStudents.filter(s => s.affiliation === user.affiliation).length, key: "total", unitPrefix: "", unitSuffix: " alunos" },
    { metric: "Novos (Mês)", value: 5, key: "new", unitPrefix: "+", unitSuffix: ""},
              ...
              >
                ...
                <Bar dataKey="value" radius={[8, 8, 0, 0]}>
                  <LabelList
                    ...
                    fontSize={12}
                    formatter={(value: number, _index: number, { payload }: any) => {
                      return `${payload.unitPrefix || ''}${value}${payload.unitSuffix || ''}`;
                    }}
                  />
