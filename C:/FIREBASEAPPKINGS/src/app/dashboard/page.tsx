    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="md:col-span-2 lg:col-span-3">
            <CardHeader>
                ...
                <CardDescription>
                    Desempenho da filial {user.affiliation}.
                </CardDescription>
            </CardHeader>
            <CardContent>
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    ...
                    <div className="rounded-lg border p-3 text-center">
                        ...
                        <p className="text-xs text-muted-foreground">Retenção (Trim.)</p>
                    </div>
                    <div className="rounded-lg border p-3 text-center">
                        <p className="text-2xl font-bold">89%</p>
                        <p className="text-xs text-muted-foreground">Engajamento (Check-in)</p>
                    </div>
                </div>
            </CardContent>
        </Card>
