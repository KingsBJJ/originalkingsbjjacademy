...
export default function NewBranchPage() {
    ...
    async function fetchInstructors() {
        try {
            ...
            toast({
                ...
                description: 'Não foi possível buscar a lista de professores para seleção. Tente novamente.',
            });
        }
    }
    fetchInstructors();
  ...
  const renderInstructorOptions = () => {
    if (instructors.length === 0) {
      return <SelectItem value="loading" disabled>Carregando professores...</SelectItem>;
    }
