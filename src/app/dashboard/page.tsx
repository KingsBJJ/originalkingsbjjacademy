  ...
  <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
     <Card>
        ...
        <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Alunos ativos em todas as filiais</p>
        </CardContent>
    </Card>
    <Card>
        <CardHeader>
     ...
     <Card>
        ...
        <CardContent>
            <p className="text-4xl font-bold">4</p>
             <p className="text-xs text-muted-foreground">Professores em todas as filiais</p>
        </CardContent>
    </Card>
  </div>
);
...
const StudentDashboard = () => {
    ...
    const nextClass = mockClasses.find(c => c.branchId === user.branchId) || mockClasses[0];
